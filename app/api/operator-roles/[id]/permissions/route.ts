...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const module = searchParams.get("module"); // Optional module filter
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const { permissions, module } = body; // module is required
    ...
    // Delete existing permissions for this module only
    await supabase
      .from("operator_role_permissions")
      .delete()
      .eq("role_id", id)
